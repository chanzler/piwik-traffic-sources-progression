...
class TrafficSourcesProgression extends \Piwik\Plugin {
	...
	public function getListHooksRegistered() {
		return array('AssetManager.getJavaScriptFiles' => 'getJsFiles', 'AssetManager.getStylesheetFiles' => 'getStylesheetFiles', 'WidgetsList.addWidgets' => 'addWidget', );
	}

	public function getJsFiles(&$jsFiles) {
		$jsFiles[] = 'plugins/TrafficSourcesProgression/javascripts/jquery.flot.js';
		$jsFiles[] = 'plugins/TrafficSourcesProgression/javascripts/jquery.flot.crosshair.js';
